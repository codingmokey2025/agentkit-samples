...
| - | - |
| **Agent Service** | [agent.py](https://github.com/volcengine/agentkit-samples/blob/main/python/02-use-cases/restaurant_ordering/agent.py#L82-L117) - order_agent, the ordering assistant |
| **Test Script** | [main.py](https://github.com/volcengine/agentkit-samples/blob/main/python/02-use-cases/restaurant_ordering/main.py) - Complete ordering process demonstration |
...
**Asynchronous Tool Definition** ([agent.py](https://github.com/volcengine/agentkit-samples/blob/main/python/02-use-cases/restaurant_ordering/agent.py#L52-L79)):
...
**Agent Configuration and Parallel Calls** ([agent.py](https://github.com/volcengine/agentkit-samples/blob/main/python/02-use-cases/restaurant_ordering/agent.py#L82-L117)):
...
**Custom Plugin** ([agent.py](https://github.com/volcengine/agentkit-samples/blob/main/python/02-use-cases/restaurant_ordering/agent.py#L120-L144)):
...
**Context Management Configuration** ([agent.py](https://github.com/volcengine/agentkit-samples/blob/main/python/02-use-cases/restaurant_ordering/agent.py#L151-L167)):
